...
<div class="hero-unit">
    <h1>Descripción grande del sitio</h1>
    <p>Nota descriptiva pequeña</p>
    <p>{{ link_to('session/register', 'Registrarse &raquo;', 'class': 'btn btn-primary btn-large btn-success') }}</p>
</div>
